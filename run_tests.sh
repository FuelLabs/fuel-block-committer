...
PATH="$script_location/target/release:$PATH" cargo test --manifest-path "$workspace_cargo_manifest" --package e2e-tests --test eigen_state -- --test-threads=1 --nocapture
