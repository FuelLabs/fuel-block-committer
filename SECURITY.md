...
Instead, please use the GitHub Security Advisory ["Report a Vulnerability"](https://github.com/FuelLabs/fuel-block-committer/security/advisories/new) tab.
...
If the issue is not security-related, please report it publicly by opening a [GitHub Issue](https://github.com/FuelLabs/fuel-block-committer/issues/new).
