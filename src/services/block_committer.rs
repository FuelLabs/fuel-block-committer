...
use crate::{
    adapters::{
        ethereum_adapter::{EthereumAdapter, EthereumWs},
        fuel_adapter::FuelBlock,
        runner::Runner,
        storage::{postgresql::Postgres, BlockSubmission, Storage},
    },
    errors::Result,
};

pub struct BlockCommitter<A = EthereumWs, Db = Postgres> {
...
mod tests {
    ...
    use super::*;
    use crate::adapters::{
        ethereum_adapter::MockEthereumAdapter, storage::postgresql::PostgresProcess,
    };
